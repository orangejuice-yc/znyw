...
const Navigation = () => {
      ...
      children: [
        {
          ...
          children: [
            {
              label: (<Link to="/reliability">线网设备可靠性平均指标</Link>),
              key: '1-1-1',
            },
            {
              label: (<Link to="/reliabilitytrends">线网设备可靠性平均指标趋势</Link>),
              key: '1-1-2',
            },
          ],
        },
  ...
  return (
    <Sider collapsible collapsed={collapsed} onCollapse={value => setCollapsed(value)}>
      <div className="logo" />
      <Menu theme="dark" defaultSelectedKeys={['0']} onClick={onClick} selectedKeys={[current]}  mode="inline" items={items} />
    </Sider>
  )
};
